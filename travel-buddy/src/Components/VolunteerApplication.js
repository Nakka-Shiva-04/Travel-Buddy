    ...
    return <div>
        ...
        {showApplication && ( <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                required /></div><br />
                <div class="volunteerapplicationsubmitbuttonstyle"><input class="btn btn-primary" type="submit" /></div>
                <div class="brs"><input class="btn btn-secondary" type="reset" /></div></center>
            </form>
        </div>)}
        {showMessage && (
            <div>
